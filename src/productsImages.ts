import product1 from '/src/assets/img/products/product1.png'
import product2 from '/src/assets/img/products/product2.png'
import product3 from '/src/assets/img/products/product3.png'
